...
<html>
    <body>
        <div class="card">
            <c:choose>
                <c:when test="${debate.debateStatus.name == 'open' && pageContext.request.userPrincipal.name != null && (pageContext.request.userPrincipal.name == debate.creatorUsername || pageContext.request.userPrincipal.name == debate.opponentUsername)}">
