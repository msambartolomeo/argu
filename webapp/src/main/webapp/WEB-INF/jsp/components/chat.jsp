        ...
        <form:form modelAttribute="chatForm" action="${postPath}" method="post" acceptCharset="utf-8" id="postForm">
            <div class="send-chat">
                <div class="input-field flex-grow">
                    ...
                    <form:input class="materialize-textarea ${not empty messageError ? 'invalid' : ''}" path="message"/>
                    <form:errors path="message" element="span" cssClass="error"/>
                </div>
                <button class="btn waves-effect center-block submitBtn" type="submit" name="chat" form="postForm">
