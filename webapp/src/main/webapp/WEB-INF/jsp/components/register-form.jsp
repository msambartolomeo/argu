    ...
    <form:form modelAttribute="registerForm" action="${postPath}" method="post" acceptCharset="utf-8">
        <div class="card-content">
            ...
            <div class="input-field">
                ...
                <form:input type="text" path="email" cssClass="${not empty emailError || userNotFound.isEmail() ? 'invalid' : ''}" />
                <form:errors path="email" cssClass="helper-text error"/>
                <c:if test="${userNotFound.isEmail()}">
            ...
            <div class="input-field">
                ...
                <form:input type="text" path="username" cssClass="${not empty usernameError || userNotFound.isUsername() ? 'invalid' : ''}"/>
                <form:errors path="username" cssClass="helper-text error" />
                <c:if test="${userNotFound.isUsername()}">
