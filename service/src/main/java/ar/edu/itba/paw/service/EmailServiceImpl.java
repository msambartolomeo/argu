...
public class EmailServiceImpl implements EmailService {
    ...
    private final String htmlMailFirstHalf = "<!DOCTYPE html\n" +
            ...
            "                                                                        <p\n" +
            "                                                                            style=\"Margin: 0; -webkit-text-size-adjust: " +
            "none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-size: 14px; font-family: helvetica, 'helvetica neue', arial, verdana, sans-serif; line-height: 150%; color: #ffff;\">\n";

    private final String htmlMailSecondHalf =
            "                                                                        </p>\n" +
                    "                                                                    </td>\n" +
                    "                                                                </tr>\n" +
                    "                                                            </tbody>\n" +
...
//    private final String baseUrl = "http://localhost:8080/";
    ...
    public void notifyNewPost(String to, String from, long debateId, String debateName) {
        ...
        String htmlMsg = htmlMailFirstHalf +
